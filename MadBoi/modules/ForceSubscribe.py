...
from MadBoi import DRAGONS as SUDO_USERS, okay
            ...
            if chat_member.restricted_by.id == (client.get_me()).id:
                try:
                    ...
                    client.answer_callback_query(
                        cb.id,
                        text=f"❗ Hey there.. Join my Channel @{channel}. After joining press 'UnMute Me' button.",
                        show_alert=True,
                    )
            else:
                client.answer_callback_query(
        ...
        if (
            ...
            try:
                ...
                try:
                    ...
                    sent_message.edit(
                        "❗ **Admin +$$4&..**\n__Need Ban Permissions  Admin ද.. \n#Ending FSub...__"
                    )
...
def config(client, message):
    ...
    if user.status is "creator" or user.user.id in SUDO_USERS or user.user.id == okay:
        chat_id = message.chat.id
...
✪ I can stop texting of members in your group until they subscribe to one or more channels, that you describe.
✪ If members are not connected to your channel, I can mute them and tell them to join the channel and I can unmute them at the push of a button.

*Setup*
1) First of all add me in the group as admin with ban users permission and in the channel as admin. If members are not connected to your channel, I can mute them and tell them to join the channel and I can unmute them at the push of a button.
