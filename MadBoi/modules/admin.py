...
from MadBoi import DRAGONS, dispatcher, okay
...
from MadBoi.modules.helper_funcs.extraction import extract_user, extract_user_and_text
...
def demote(update: Update, context: CallbackContext) -> str:
    ...
    if not user_member.status == "administrator":
        message.reply_text("Can't demote one who never got promoted!")
        return
...
def set_title(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        message.reply_text(
            "I can't set my own title myself! Get the one who made me admin or the owner of chat, to do it for me."
        )
        return
