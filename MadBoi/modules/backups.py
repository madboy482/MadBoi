...
# from MadBoi.modules.sql import warns_sql as warnssql
import MadBoi.modules.sql.blacklist_sql as blacklistsql

# from MadBoi.modules.sql import cust_filters_sql as filtersql
# import MadBoi.modules.sql.welcome_sql as welcsql
import MadBoi.modules.sql.locks_sql as locksql
import MadBoi.modules.sql.notes_sql as sql

# from MadBoi.modules.rules import get_rules
import MadBoi.modules.sql.rules_sql as rulessql
from MadBoi import JOIN_LOGGER, LOGGER, OWNER_ID, dispatcher
from MadBoi.__main__ import DATA_IMPORT
from MadBoi.modules.connection import connected
from MadBoi.modules.helper_funcs.alternate import typing_action
from MadBoi.modules.helper_funcs.chat_status import user_admin
from MadBoi.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    f = open("ROMEO-3.0{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ROMEO-3.0{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ROMEO-3.0` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ROMEO-3.0{}.backup".format(chat_id))  # Cleaning file
...
*Only for group owner:*
 ...
 ✪ `/import`: Reply to the backup file for the butler / ROMEO-3.0 group to import as much as possible, making transfers very easy! \
