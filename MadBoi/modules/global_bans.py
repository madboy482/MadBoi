...
import MadBoi.modules.sql.global_bans_sql as sql
from MadBoi import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from MadBoi.modules.helper_funcs.misc import send_to_list
from MadBoi.modules.sql.users_sql import get_user_com_chats
