...
import MadBoi.modules.sql.blacklistusers_sql
sql = MadBoi.modules.sql.blacklistusers_sql
from MadBoi import ALLOW_EXCL, DEMONS, DEV_USERS, DRAGONS, TIGERS, WOLVES
