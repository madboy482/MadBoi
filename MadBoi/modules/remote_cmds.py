...
def rban(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        message.reply_text("Why would I ban myself?? Noob, Nibba!!!🤧🤧🙄")
        return

    try:
        chat.kick_member(user_id)
        message.reply_text("Banned from chat!☺️")
    except BadRequest as excp:
...
def runban(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        message.reply_text("I'm not gonna UNBAN myself, I'm an admin there! 🤧Nibba🤧")
        return
...
def rkick(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        message.reply_text("Why would I kick myself?? Noob, Nibba🤧🤧🙄")
        return
...
def runmute(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        message.reply_text("I'm not gonna UNMUTE myself, I'm an admin there! 🤧Nibba🤧")
        return
