    ...
    if msg.reply_to_message:
        ...
        if packnum > 0:
            ...
            for i in range(0, packnum + 1):
                if i == 0:
                    packs += f"_[Pack](t.me/addstickers/{firstpackname})_\n"
                else:
                    packs += f"_[Pack{i}](t.me/addstickers/{packname})_\n"
        else:
            packs += f"_[Pack](t.me/addstickers/{packname})_"
...
def makepack_internal(
    ...
    try:
        ...
        if e.message == "Sticker set name is already occupied":
            msg.reply_text(
                "*☞ Your pack can be found [HERE](t.me/addstickers/{packname})_*"
                "\n\n*_Pᴀᴄᴋ Kᴀɴɢᴇᴅ ʙʏ Rᴏᴍᴇᴏ-3.0_*",
                parse_mode=ParseMode.MARKDOWN,
            )
