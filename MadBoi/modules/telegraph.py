...
boi = "MadBoi"
telegraph = Telegraph()
r = telegraph.create_account(short_name=boi)
auth_url = r["auth_url"]
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "m":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await h.edit("Uploaded to Telegra.ph\n\nhttps://telegra.ph{} \nin {} seconds.".format(media_urls[0], (ms + ms_two)), link_preview=True)
        elif input_str == "t":
            ...
            ms = (end - start).seconds
            await event.reply("Pasted to Telegra.ph\n\nhttps://telegra.ph/{} \nin {} seconds.".format(response["path"], ms), link_preview=True)
    else:
