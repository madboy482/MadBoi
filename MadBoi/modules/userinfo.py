...
import MadBoi.modules.sql.userinfo_sql as sql
from MadBoi import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from MadBoi import telethn as SaitamaTelethonClient
from MadBoi.__main__ import STATS, TOKEN, USER_INFO
from MadBoi.modules.disable import DisableAbleCommandHandler
from MadBoi.modules.helper_funcs.chat_status import sudo_plus
from MadBoi.modules.helper_funcs.extraction import extract_user
from MadBoi.modules.sql.afk_sql import check_afk_status, is_afk
from MadBoi.modules.sql.global_bans_sql import is_user_gbanned
from MadBoi.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    try:
        ...
        if spamwtc:
            text += "\n\n<b><i>This person is SpamWatched!</i></b>"
...
def users(update: Update, context: CallbackContext):
    ...
    users = "<b><i>Current stats:</i></b>\n<b><i>Loaded from ROMEO-3.0 DataBase...✅</i></b>\n" + "\n" + output + "\n".join(
    ...
    if message.reply_to_message:
        ...
        if len(bio) == 2:
            if len(bio[1]) < MAX_MESSAGE_LENGTH // 4:
                ...
                message.reply_text(
                    "Bio needs to be under {} characters! You tried to f {}."
