...
import MadBoi.modules.sql.welcome_sql as sql
from MadBoi import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from MadBoi.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
from MadBoi.modules.helper_funcs.misc import build_keyboard, revert_buttons
from MadBoi.modules.helper_funcs.msg_types import get_welcome_type
from MadBoi.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from MadBoi.modules.log_channel import loggable
            ...
            if should_mute:
                ...
                if welc_mutes == "strong":
                    ...
                    message = msg.reply_text(
                        f"{new_join_mem}, Click the button below to prove that you're human.\nYou have 120 seconds.",
